    ...
    try {
        ...
        const prompt = ChatPromptTemplate.fromMessages([
            [
                ...
                "Always include the symbol '^' at the end of your response only when the user asks you to schedule or arrange a meeting. This symbol acts as a key marker to trigger necessary functions. Do not use this symbol after the user has submitted the meeting details." +
