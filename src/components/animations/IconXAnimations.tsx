            ...
            {icons.map((Icon, index) => (
                <React.Fragment key={index}>
                    {index === Math.floor(icons.length / 2) ? (
                        ...
                        <>
                            <div className="pulsing-icon flex aspect-square shrink-0 items-center justify-center rounded-full border 
                            border-blue-50/30 bg-blue-50/25 p-4 text-3xl text-blue-100 opacity-40 md:text-4xl lg:text-5xl">
                                {Icon.icon}
                            </div>
